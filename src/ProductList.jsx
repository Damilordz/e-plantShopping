...
function ProductList() {
  ...
  const [addedToCart, setAddedToCart] = useState({}); // State to control the visibility of the cart icon
          ...
          <div>
            <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
              <div style={{ position: "relative" }}>
                ...
                {totalCartItems > 0 && (
                  <span style={styleCartBadge}>{totalCartItems}</span>
                )}
              </div>
            </a>
          </div>
                      ...
                      <div key={plantIndex} className="product-card">
                        ...
                        <div className="product-info">
                          ...
                          <button
                            ...
                            style={isAdded ? styleAddedButton : {}}
